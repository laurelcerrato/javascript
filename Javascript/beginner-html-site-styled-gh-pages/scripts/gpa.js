...
//     const cleanGrades = gradesArray.map((letter) => {
//         letter.toUpperCase();
//         grades = letter.trim();
//         // return grades
//         return grades
...
//     const gradeList = grades.map((grades) => lookupGrade(grades));
//     // calculates the GPA
//     const reduceList = list.reduce((total,num) => total + num )/ gradeList.lenght;
//     // return the GPA
//     let gpa = reduceList.toFixed(2);
//     return gpa;
//   }
